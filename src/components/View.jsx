    ...
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient     rounded-[10px] mb-2">
          <img src={discount} alt="image" className='h-[32px] w-[32px]' />
      ...
      <div className= {`flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        ...
        <div className="absolute z-[1] w-[80%] h-[80%] rounded-full bottom-40 whit__gradient" />
        <div className="absolute z-[0] w-[50%] h-[50%] right-50 bottom-20 blue__gradient"/>
      </div>
